...
@endsection
@section('content')
	<form action="{{ route('store.category.main') }}" method="post">
        @csrf
        <div data-mdb-input-init class="form-outline mb-4">
            <input type="text" id="form1Example1" class="form-control" name="MainCategory"  style="width: 500px;display: inline;"/>
            <label class="form-label" for="form1Example1" style="width: 500px;display: inline;">Main Category name</label>
        </div>

        <button data-mdb-ripple-init type="submit" class="btn btn-primary btn-block">Add New Main Category</button>
    </form>
				<!-- <div class="row">
