...
@section('page-header')
				...
				<form action="{{ route('store.book') }}" method="post">
					...
					<div data-mdb-input-init class="form-outline mb-4">
						<input type="text" id="form1Example1" class="form-control" name="bookname" />
						<label class="form-label" for="form1Example1">Book Name</label>
					</div>
					<div data-mdb-input-init class="form-outline mb-4">
						<input type="text" id="form1Example1" class="form-control" name="bookauthor" />
						<label class="form-label" for="form1Example1">Book author</label>
					</div>
					<div data-mdb-input-init class="form-outline mb-4">
						<input type="text" id="form1Example1" class="form-control" name="bookdisc" />
						<label class="form-label" for="form1Example1">Book Discribtion</label>
					</div>
				
					@foreach ($subs as $sub)
							<div class="form-check">
								<input class="form-check-input" type="checkbox" name="subid" value="{{ $sub->id }}" id="flexCheckDefault">
								&nbsp;
								&nbsp;
								&nbsp;
					...
					<button data-mdb-ripple-init type="submit" class="btn btn-primary btn-block">Add New Book</button>
    </form>
					<!-- <div class="my-auto">
