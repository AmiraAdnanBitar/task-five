...
<body>
    ...
    <form action="{{ route('welcome') }}" method="get">
        @csrf
        <button data-mdb-ripple-init type="submit" class="btn btn-primary btn-block">log out</button>
    </form>
    <form action="{{ route('add_main_category') }}" method="get">
        @csrf
        <button data-mdb-ripple-init type="submit" class="btn btn-primary btn-block">Add Main Category</button>
    </form>


    <form action="{{ route('add_sub_category') }}" method="get">
        @csrf
        <button data-mdb-ripple-init type="submit" class="btn btn-primary btn-block">Add Sub Category</button>
    </form>
    <form action="{{ route('add_book') }}" method="get">
        @csrf
        <button data-mdb-ripple-init type="submit" class="btn btn-primary btn-block">Add Book</button>
    </form>
</body>
</html> -->
