...
<form action="{{ route('store.category.sub') }}" method="post">
        @csrf
        <!-- <div data-mdb-input-init class="form-outline mb-4"> -->
            <input type="text" id="form1Example1" class="form-control" name="SubCategory" style="width: 500px;display: inline;" />
            <label class="form-label" for="form1Example1" style="display: inline;">Sub Category name</label>
        <!-- </div> -->
        @foreach ($mains as $main)
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="main" value="{{ $main->id }}" id="flexCheckDefault">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <button data-mdb-ripple-init type="submit" class="btn btn-primary btn-block">Add New Sub Category</button>
    </form>
				<!-- Row -->
				<!-- <div class="sortable">
